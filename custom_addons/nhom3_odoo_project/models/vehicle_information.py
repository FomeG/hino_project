...
class VehicleInformation(models.Model):
    ...
    contact_phone = fields.Char(related='owner_info.phone', string='Phone of owner', tracking=True)
    driver = fields.Many2one('res.partner', string='Driver', tracking=True)
    driver_phone = fields.Char(related='driver.phone', string='Phone of driver', tracking=True)
    ...
    contact_phone_2 = fields.Char(related='contact.phone', string='Phone of contact', tracking=True)
